function home_display() {
  ...
  document.getElementById("business-txt").style.display = "none";
  ...
  document.getElementById("business-lb").style.background = "none";
}
...
function business_display() {
  ...
  document.getElementById("project-txt").style.display = "none";
  document.getElementById("about-txt").style.display = "none";
  document.getElementById("business-txt").style.display = "block";
  ...
  document.getElementById("project-lb").style.background = "none";
  document.getElementById("about-lb").style.background = "none";
  document.getElementById("business-lb").style.background = "#589167";
}
